...
<!-- Updated: 2026-09-21 (v1.5.22: rule 9 — write-first ordering, no self-declared context stop) · 2026-08-19 — Audit-360 feedback loop: Operational Surface section (DocumentRoot probe, config-matching rules, operator-script guards). Trimmed stale changelog comments. -->
